...
class GeocodeFarmTestCases(unittest.TestCase):
    ...
    def testGoogle(self):
        ...
        self.assertIsInstance(self.geolocator5, GoogleV3, "The object is not an instance of class GoogleV3")
        
        #assert the url built
        self.assertEqual(self.geolocator5.scheme, self.scheme)
        self.assertEqual(self.geolocator5.domain, self.googledomain)
        self.assertEqual(self.geolocator5.api, self.googleurl)
